<template>
   <div class="app-container">
      ...
      <el-table ref="logininforRef" v-loading="loading" :data="logininforList" v-column-resize @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
